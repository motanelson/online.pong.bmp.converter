...
<body>
    <h1>Upload a png2bmp File</h1>
    <form method="post" action="/upload" enctype="multipart/form-data">
        <input type="file" name="cfile" accept=".png" required />
...
<body>
    <h1>Download a png2bmp File</h1>
    <a href="$file">.bmp</a><br>
...
def upload_file():
    ...
    # Salvar o arquivo
    c_file_path = os.path.join(UPLOAD_FOLDER, str(file_counters)+".png")
    file.save(c_file_path)

    # Nome do executável
    executable_name = f"{file_counters}.bmp"
